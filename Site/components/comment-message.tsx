...
export function CommentMessage({
  ...
  const containerPadding = isReply ? "pl-0" : "px-1";

  return (
    <div
      className={cn(
        "flex gap-3 animate-comment-appear",
        containerPadding
      )}
    ...
    >
      <div className="flex flex-col items-center">
        <div className={cn("shrink-0 overflow-hidden rounded-full border border-white/10 bg-neutral-800", avatarSize)}>
          ...
          <div className="flex-1 min-w-0 space-y-1">
            ...
            {isEditing ? (
              <div className="space-y-3 pt-1">
                ...
                <div className="flex justify-end gap-2 text-xs">
                  <button
                    type="button"
                    className="rounded-full border border-white/10 px-3 py-1 text-neutral-400 hover:border-white/20 hover:text-white active:scale-95 transition-transform"
                    onClick={resetEdit}
                    disabled={pending}
                  >
                    Cancel
                  ...
                  <button
                    type="button"
                    className="rounded-full bg-white px-4 py-1 font-semibold text-black hover:bg-neutral-200 disabled:opacity-50 active:scale-95 transition-transform"
                    onClick={handleSave}
            ...
            <div className="flex flex-wrap items-center gap-4 pt-0.5">
              {canReply && (
                <button
                  type="button"
                  className="group flex items-center gap-1.5 text-xs font-medium text-neutral-400 hover:text-white active:scale-95 transition-all"
              ...
              <button
                type="button"
                className={cn(
                  "group flex items-center gap-1.5 text-xs font-medium transition-all active:scale-95",
              ...
              {canEdit && (
                <button
                  type="button"
                  className="flex items-center gap-1 text-xs font-medium text-neutral-400 hover:text-white active:scale-95 transition-transform"
